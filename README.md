...
*. docker run --name exathreat-portal -e PROFILE=aws -e DB_URL=192.168.1.82 -e DB_PORT=3306 -e DB_NAME=exathreat -e DB_USERNAME=portal -e DB_PASSWORD=<DB_PASSWORD> -e ES_DOMAIN=192.168.1.82 -e ES_PORT=9200 -e ES_SCHEME=http -e WEB_DOMAIN=localhost:8080 -p 8080:8080 exathreat-portal
...
*. docker tag exathreat-portal <AWS_ACCOUNT_ID>.dkr.ecr.ap-southeast-2.amazonaws.com/exathreat-portal

To push your tagged docker image to your ECR repository in AWS:
*. docker push <AWS_ACCOUNT_ID>.dkr.ecr.ap-southeast-2.amazonaws.com/exathreat-portal

To pull your docker image from your ECR repository in AWS:
*. docker pull <AWS_ACCOUNT_ID>.dkr.ecr.ap-southeast-2.amazonaws.com/exathreat-portal
